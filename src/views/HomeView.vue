<template>
  <div class="about">
    <h1 class="text-center font-bold text-4xl">This is an Home page</h1>
  </div>
  ...
  <div class="flex items-center justify-center w-full h-full button">
    <RouterLink to="/product-list"
      ...
      <span class="relative w-full text-left transition-colors duration-200 ease-in-out group-hover:text-white">Go Product List Page</span>
    </RouterLink>
  </div>
